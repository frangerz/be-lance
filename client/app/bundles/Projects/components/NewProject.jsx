...
// Simple example of a React "dumb" component
 export default class NewProject extends React.Component {
  ...
  onChange(e) {
    // preparing for adding state and state mutations to new project form...
  ...
  render() {
    ...
    return (
      ...
      <div className="form-group row">
          <label for="project_name" className="col-sm-3 form-control-label">Project Name</label>
          <div className="col-sm-9">
            <input type="text" onChange={this.onChange} className="form-control" id="name" placeholder="New Project Name"/>
          </div>
        </div>
        <div className="form-group row">
