...
class BankDetailsControllerTest < ActionController::TestCase
  ...
  test "should create bank_detail" do
    assert_difference('BankDetail.count') do
      post :create, bank_detail: { description: @bank_detail.description, service: @bank_detail.service, type: @bank_detail.type }
    end
  ...
  test "should update bank_detail" do
    patch :update, id: @bank_detail, bank_detail: { description: @bank_detail.description, service: @bank_detail.service, type: @bank_detail.type }
    assert_redirected_to bank_detail_path(assigns(:bank_detail))
  end
