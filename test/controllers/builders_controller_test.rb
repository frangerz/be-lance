...
class BuildersControllerTest < ActionController::TestCase
  ...
  test "should create builder" do
    assert_difference('Builder.count') do
      post :create, builder: { address: @builder.address, company: @builder.company, dob: @builder.dob, firstname: @builder.firstname, joint: @builder.joint, phone: @builder.phone, surname: @builder.surname }
    end
  ...
  test "should update builder" do
    patch :update, id: @builder, builder: { address: @builder.address, company: @builder.company, dob: @builder.dob, firstname: @builder.firstname, joint: @builder.joint, phone: @builder.phone, surname: @builder.surname }
    assert_redirected_to builder_path(assigns(:builder))
  end
