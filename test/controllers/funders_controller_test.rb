...
class ServiceProvidersControllerTest < ActionController::TestCase
  ...
  test "should create service_provider" do
    assert_difference('ServiceProvider.count') do
      post :create, service_provider: { address: @service_provider.address, dob: @service_provider.dob, firstname: @service_provider.firstname, joint: @service_provider.joint, phone: @service_provider.phone, surname: @service_provider.surname }
    end
  ...
  test "should update service_provider" do
    patch :update, id: @service_provider, service_provider: { address: @service_provider.address, dob: @service_provider.dob, firstname: @service_provider.firstname, joint: @service_provider.joint, phone: @service_provider.phone, surname: @service_provider.surname }
    assert_redirected_to service_provider_path(assigns(:service_provider))
  end
